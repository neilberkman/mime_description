...
https://github.com/neilberkman/mime_description/security/advisories/new
...
[Hex](https://hex.pm/packages/mime_description). Please upgrade to the latest version before
reporting an issue.
